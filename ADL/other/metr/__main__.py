...
def make_parser() -> argparse.ArgumentParser:
    ...
    """
    parser = argparse.ArgumentParser(description="Script for calculating metrics of catalogs.",
                                     formatter_class=RawTextHelpFormatter)
    parser.add_argument("det_path", metavar="<det_path>",
                        help="Path to detected catalog.")
    parser.add_argument("true_dir_path", metavar="<true_dir_path>",
    ...
    parser.add_argument("--rules", metavar="<rules>", default="",
    ...
    parser.add_argument("--range_prm", metavar="<range_prm>", default="max_pred",
